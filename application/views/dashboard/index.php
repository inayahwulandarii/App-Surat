            ...
            <div class="col-md-4">
                <div class="card card-chart">
                    ...
                    <div class="card-content">
                        ...
                        <p class="category">Surat Masuk Dinas PMD</p>
                    </div>
            ...
            <div class="col-md-4">
                <div class="card card-chart">
                    ...
                    <div class="card-content">
                        ...
                        <p class="category">
                            <span class="text-success"></span> Surat Keluar Dinas PMD</p>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
            ...
            <div class="col-md-4">
                <div class="card card-chart">
                    ...
                    <div class="card-content">
                        ...
                        <p class="category">Surat Keterangan Dinas PMD</p>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            <i class="material-icons">info</i> Jumlah Pegawai
                        </div>
                    </div>
                </div>
            </div>
