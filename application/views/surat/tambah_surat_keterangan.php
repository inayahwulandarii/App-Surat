            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Tambah Surat Keterangan</h4>
                        ...
                        <div class="category form-category">
                            <div class="form-footer text-right">
                                ...
                                <button type="submit" class="btn btn-success btn-fill">simpan</button><a class="btn btn-danger pull-right" href="<?= base_url('surat/surat_masuk')?>">Kembali</a>
                            </div>
                        </div>
                        </form>
                    </div>
