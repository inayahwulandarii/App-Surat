				...
				<ul class="nav">
					...
					<li class="
                        ...
                        " id="formsExamples">
							<ul class="nav">
								<li class="
                                <?php if ($sub_title == 'Profil Dinas PMD') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
									<a href="<?= base_url() ?>galery/profil_kelurahan">
										<span class="sidebar-mini">RF</span>
										<span class="sidebar-normal">Profil Dinas PMD</span>
									</a>
								</li>
								<li class="
                                <?php if ($sub_title == 'Struktur Dinas PMD') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
									<a href="<?= base_url() ?>galery/s_kelurahan">
										<span class="sidebar-mini">EF</span>
										<span class="sidebar-normal">Struktur Dinas PMD</span>
									</a>
								</li>
							</ul>
						</div>
