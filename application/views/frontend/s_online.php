<section class="page-section">
    <div class="container">
        ...
        <div class="text-center">
            ...
            <div class="section-subheading text-muted">Isi Form Pengajuan Surat Dibawah:</div>
        </div>
        <br></br>
        <div class="text-justify pl-5 pr-5">
            ...
            <a class="section-subheading text-muted btn btn-simple data-dismiss" href="<?= base_url('home')?>">Kembali</a>
            </div> 
        </div>
    </div>
