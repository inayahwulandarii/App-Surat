...
class Galery extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('s_kelurahan', 'Struktur Dinas PMD', 'trim');
    ...
    {
        $this->form_validation->set_rules('s_lpm', 'Struktur Dinas PMD', 'trim');
